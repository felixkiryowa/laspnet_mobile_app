...
@Component({
  ...
  templateUrl: './criminal-details.page.html',
  styleUrls: ['./criminal-details.page.scss'],
})
export class CriminalDetailsPage implements OnInit {
  ...
  magistrateCourtAct: Array<any> = [
    {
      ...
      steps : [
        {
          step: 'By a police officer bringing a person arrested with or without a warrant before a magistrate upon a charge;',
        }, 
        {
          step: `By a public prosecutor or a police officer laying a charge against a person before a magistrate and requesting 
          the issue of a warrant or a summons`,
        },
        {
          step : `By any person, other than a public prosecutor or a police officer, 
    ...
    },
    {
      ...
      steps: [
        {
          step: 'laid under the provisions of subsection (1)(b); or',
        },
        {
          step:`
